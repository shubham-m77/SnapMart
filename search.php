...
<head>
    ...
    <title>SnapMart - Search List</title>
...
if (empty($_GET['search'])) {
  echo "<div class='text-center mt-5'><h3>Please enter a valid search term.</h3></div>";
  exit;
}
$search=$_GET['search'];
$search_name=ucfirst($search);
$product_data=$db->query("SELECT * FROM products WHERE product_name LIKE '%$search%' ORDER BY id DESC"); 
    echo "<div class='row'>
    <h2 class='text-center mt-4'>$search_name</h2>
    <hr>
    ";
