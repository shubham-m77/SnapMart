...
<div id="carouselExample" class="carousel slide" >
  <div class="carousel-inner" >
    <div class="carousel-item active" >
      <img src="images/vivo-x200-pro-banner.webp" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="images/realme-gt-7-pro-banner.webp" class="d-block w-100" alt="...">
    </div>
  </div>
...
<!-- products -->
    ...
    $category=$array['category_url'];
    $category_name=$array['category_name'];
    $product_data=$db->query("SELECT * FROM products WHERE category='$category' ORDER BY id DESC LIMIT 4"); 
    echo "<div class='row'>
    <h2 class='text-center my-4'>".$category_name."</h2>
    ";
    while($prd_array=$product_data->fetch_assoc()){
        echo "<div class='col-md-3 px-4'>
        <a href='Product-details/".$prd_array["id"]."'>
        <div class='card d-flex justify-content-center align-items-center'>
        <img src='images/".$prd_array['product_img']."' class='w-50 py-2 pb-0'>
    ...
    echo "
     <div class='my-3 text-center'>
            ...
            <i class='fas fa-chevron-circle-down fs-1 text-primary'></i>
            </a>
            </div>
    </div>";
    }
